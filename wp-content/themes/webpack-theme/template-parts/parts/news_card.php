<a href="<?php the_permalink(); ?>" class="fade-in overflow-hidden relative flex flex-col grow justify-end  text-white aspect-[0.96] cursor-pointer group p-8  max-lg:p-4 h-[31.25rem] max-md:h-[20rem] w-full bg-aliceblue  group transition-all  delay-200">
    ...
    <div class="absolute top-0 z-10 mt-8 text-white max-md:text-white justify-center self-start px-5 py-2 max-md:py-1.5 whitespace-nowrap border  border-white border-solid transition-all group-hover:border-white delay-200 group-hover:text-white">News</div>
