 <a href="<?php the_permalink(); ?>" class="flex overflow-hidden relative flex-col justify-between p-8 max-md:p-[1.25rem] text-black h-[31.25rem] max-md:h-[22.5rem] w-full bg-aliceblue max-md:text-white group transition-all hover:text-white delay-200 cursor-pointer">
     <?php
     ...
     <div class="relative text-black max-md:text-white justify-center self-start px-5 py-2 max-md:py-1.5 whitespace-nowrap border max-md:border-white border-black border-solid transition-all group-hover:border-white delay-200 group-hover:text-white">News</div>
