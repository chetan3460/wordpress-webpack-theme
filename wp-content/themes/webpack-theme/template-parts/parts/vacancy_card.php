...
<a class="c-item flex flex-col justify-between cursor-pointer  py-10 px-8 max-lg:p-4 bg-aliceblue  h-[26vw] max-lg:h-[40vw] max-md:h-[12.5rem]  transition-all duration-700 hover:bg-darkblue hover:text-white group rounded-2xl" href="<?php the_permalink(); ?>">
    <?php if ($date_posted) : ?>
        <div class="top">
