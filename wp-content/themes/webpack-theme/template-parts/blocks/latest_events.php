...
$select_events = get_sub_field('select_events');
...
if ($select_events && !$hide_block) :
?>

    <section class="py-[6.25rem]   max-md:py-12 events-list-block bg-lightblue" style="<?php if ($padding_top) { ?>padding-top: <?= $padding_top ?>px; <?php } ?><?php if ($padding_bottom) { ?>padding-bottom: <?= $padding_bottom ?>px <?php } ?>">
        <div class=" max-container">
            ...
            <div class="mt-16 max-md:mt-10 news-slider fade-in max-6xl:px-16 max-xl:px-5">
                <div class="flex gap-10 max-md:gap-7 flex-col">
                    <?php foreach ($select_events as $post) : setup_postdata($post); ?>
                        <!-- News card import -->
