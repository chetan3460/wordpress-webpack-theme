...
?>
    ...
    <section class="partner-slider-block bg-lightblue home-part  max-container fade-in  w-full  partner-slider pb-[6.25rem]">
        <div class="">
            ...
            <div class="home-part__marquee w-full overflow-hidden block ">
                <div
                    ...
                    <div class="home-part__marquee-item flex items-stretch justify-start flex-nowrap gap-3">
                        <div
                            class="mb-0 home-part__main-item border bg-lavendermist border-beige/25 -mr-[1px] py-[2.8rem] px-[1.9rem] w-[30rem]prose  gap-[20px] mb-4 rounded-xl">
