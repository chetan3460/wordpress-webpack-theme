...
<section class="py-[6.25rem]   max-md:py-12 news-list-block"
    ...
    <div class="max-container">
        ...
        <div class="mt-16 max-md:mt-10  fade-in max-6xl:px-16 max-xl:px-5">
            <div
                class="grid-layout grid gap-y-14 gap-x-5 max-md:gap-5  grid-cols-3 max-lg:grid-cols-2 max-md:grid-cols-1">
